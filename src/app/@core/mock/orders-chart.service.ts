...
export class OrdersChartService extends OrdersChartData {
  ...
  private getDataForWeekPeriod(): OrdersChart {
    return {
      ...
      linesData: [
        [
          116, 274, 404, 502, 576, 624, 
          646, 648, 622, 576, 514, 444, 
          374, 308, 248, 200, 162, 144, 
          140, 135, 142, 158, 170, 192, 
          230, 274, 322, 372, 420, 466, 
          508, 542, 568, 586, 594, 594, 
          594, 594, 594, 594, 594, 594, 594,//black
        ],
        [
          116, 274, 404, 502, 576, 624, 
          646, 648, 622, 576, 514, 444, 
          ...
          230, 274, 322, 372, 420, 466, 
          508, 542, 568, 586, 594, 594, 
          594, 594, 594, 594, 594, 594, 594 //red
       ],
        [
